...
router.patch("/v1/:id/update", passport.authenticate("jwt", { session: false }),userv1.updateUser);
router.post("/v1/:id/delete", passport.authenticate("jwt", { session: false }),userv1.deleteUser);
router.get("/v1/:id/find", userv1.findTask);

// v1.0.1
router.post("/v1.0.1/signup", userv2.signUp); // import name signup. export  signup
router.post("/v1.0.1/login", userv2.logIn);
router.patch("/v1.0.1/:id/update", passport.authenticate("jwt", { session: false }),userv2.updateUser);
